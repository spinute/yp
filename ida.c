...
/*
 * goal: [0,1,2,3,...,STATE_N - 1]
 */

#define H_VALUE_UPPER_BOUND ((STATE_WIDTH-1)*(STATE_N-1))
static char assert_h_value_bound[H_VALUE_UPPER_BOUND <= UCHAR_MAX ? 1 : -1];
